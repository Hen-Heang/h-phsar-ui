...
} from "../../redux/slices/supplier/AccountSlice";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
} from "../../redux/services/supplier/account.service";
import { update_account } from "../../redux/services/supplier/account.service";
import { getDataStore } from "../../redux/slices/supplier/storeSlice";
import { get_store_distributor_profile } from "../../redux/services/supplier/store.service";
          ...
          <div className="bg-white rounded-lg w-full shadow-md">
            <div className="w-full p-6 space-y-1 md:space-y-2 sm:px-12 sm:py-12">
              ...
              <div className="flex m-auto flex-row justify-start gap-3 lg:gap-7 items-center w-[100%]">
                <Image
                  src={
                    imageUrl || account?.profileImage || noImage.src || noImage
                  }
                  alt="Profile"
                  width={192}
                  height={192}
              ...
              <div className="flex lg:flex-row flex-col gap-8">
                <div className="lg:w-1/3">
                  ...
                  <p className="text-sm text-slate-500">
                    Update your account details and identity.
                  </p>
                </div>
                <div className="flex-1 space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-bold text-blue-800 uppercase mb-1">
                        First Name
                      </label>
                      <input
              ...
              <div className="flex lg:flex-row flex-col gap-8">
                <div className="lg:w-1/3">
                  ...
                  <p className="text-sm text-slate-500">
                    How you appear to your partners.
                  </p>
                </div>
        ...
        <DialogContent className="max-w-md p-8">
          <div className="text-center">
            ...
            <p className="text-slate-500 mb-8">
              Confirming will save your updated information to your distributor
              profile.
            </p>
