  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const formattedEndDate = dayjs(endDate)
        .endOf("month")
        .format("YYYY-MM-DD");
      const url = `${process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:8080"}/api/v1/suppliers/reports?startDate=${formattedStartDate}&endDate=${formattedEndDate}`;
      try {
        ...
        <CardHeader className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm">
                Detailed overview of your sales and performance.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Button
              ...
              className="gap-2 rounded-lg h-10 px-6"
            >
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {[
              ...
              <div
                key={idx}
                className="p-6 rounded-2xl border border-slate-100  bg-white  shadow-sm flex items-center gap-4"
              >
