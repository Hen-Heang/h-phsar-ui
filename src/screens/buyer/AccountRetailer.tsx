...
} from "../../redux/services/buyer/retailerProfile.service";
import {
  getRetailerInfo,
  setLoading,
  setError,
} from "../../redux/slices/buyer/retailerProfileSlice";
...
export default function AccountRetailer() {
  ...
  const { retailerInfo: profile, loading } = useSelector(
    (state) => state.retailerProfile,
  );
  ...
  useEffect(() => {
    document.title = "H-Phsar | Account Settings";
    if (typeof window !== "undefined") {
      setEmail(
        window.localStorage.getItem("email") || "retailer@stockflow.com",
      );
    }
    fetchProfile();
  }, [dispatch]);
        ...
        <header className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 text-slate-500 max-w-md">
              Manage your personal identification and delivery preferences for
                  ...
                  <div className="mt-10 space-y-4">
                    <div className="flex items-center gap-3 p-4 rounded-2xl bg-slate-50 border border-slate-100/50">
                      ...
                      <div className="text-left">
                        ...
                        <span className="text-xs font-bold text-slate-700 truncate block w-40">
                          {email}
                        </span>
                      </div>
                    </div>
                  ...
                  <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-3">
                        ...
                        />
                        {validationErrors.firstName && (
                          <p className="text-[10px] font-black text-rose-500 uppercase tracking-wider px-1">
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea
                        ...
                        className={cn(
                          ...
                          !isEditing
                            ? "bg-slate-50 border-slate-100 text-slate-500 cursor-not-allowed"
                            : "bg-white border-slate-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 text-slate-900",
        ...
        <DialogContent className="max-w-md p-10 rounded-[3rem] border-none shadow-2xl overflow-hidden">
          ...
          <div className="text-center relative">
            ...
            <p className="mt-4 text-slate-500 leading-relaxed font-medium">
              Confirming this will update your global profile data across the
              H-Phsar platform.
            </p>
