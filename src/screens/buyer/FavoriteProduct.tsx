...
import {
  get_only_bookmark,
  remove_bookmark,
} from "../../redux/services/buyer/favourite.service";
import {
  deleteBookMark,
  getOnlyBookmark,
  setLoadingFavorite,
} from "../../redux/slices/buyer/favoriteSlice";
import { setStoreId } from "../../redux/slices/buyer/homepageSlice/allShopSlice";
...
export default function FavoriteProduct() {
  ...
  useEffect(() => {
    document.title = "H-Phsar | My Favorites";
    fetchFavorites();
  }, []);
