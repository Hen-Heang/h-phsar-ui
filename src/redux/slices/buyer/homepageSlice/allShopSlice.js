...
const allShopSlice = createSlice({
  name: "allShopSlice",
  initialState: {
    highestRateData: /** @type {any[]} */ ([]),
    dataShop: /** @type {any[]} */ ([]),
    dataOneShop: /** @type {any[]} */ ([]),
    dataNewShop: /** @type {any[]} */ ([]),
    orderData: /** @type {any[]} */ ([]),
    bookmarkData: /** @type {any[]} */ ([]),
    orderHistoryData: /** @type {any[]} */ ([]),
    draftData: /** @type {any[]} */ ([]),
    oneShopData: /** @type {any[]} */ ([]),
    productData: /** @type {any[]} */ ([]),
    categoryData: /** @type {any[]} */ ([]),
    storeId: null,
    cartData: /** @type {any[]} */ ([]),
    productByCategoryData: /** @type {any[]} */ ([]),
    productInCartData: /** @type {any[]} */ ([]),
    orderInCartData: /** @type {any[]} */ ([]),
    deletedProductData: /** @type {any[]} */ ([]),
    productByPriceData: /** @type {any[]} */ ([]),
    productByDateData: /** @type {any[]} */ ([]),
    loadingStore: false,
    loadingCard: false,
