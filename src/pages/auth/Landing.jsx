      ...
      <main>
          ...
          <div className="relative mx-auto max-w-6xl text-center">
            ...
            >
              ...
              <p className="mx-auto mt-5 max-w-2xl text-base text-slate-600  md:text-lg">
                StockFlow is a platform that connects Products with Distributors and Retailers in their target market and helps find new and innovative products.
              </p>
        ...
        <section className="mx-auto max-w-6xl px-4 pb-24 md:px-6">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-bold text-slate-900  md:text-4xl">Our Best Features</h2>
        ...
        <section className="bg-white  py-24">
          <div className="mx-auto max-w-6xl px-4 md:px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold text-slate-900  mb-6">How Does This Work?</h2>
                <p className="text-slate-600  mb-8 text-lg">
                  StockFlow streamlines your entire supply chain process from onboarding to purchasing.
                </p>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-6">
              ...
              <p className="text-sm leading-relaxed text-slate-400 ">
                The next-generation B2B marketplace for high-performance warehouse operations. Built for distributors and retailers worldwide.
              </p>
            ...
            <div>
              <h4 className="text-xs font-black uppercase tracking-[0.2em] text-white mb-6">Organization</h4>
              <ul className="space-y-4 text-sm font-medium text-slate-400">
                <li className="hover:text-blue-500 cursor-pointer transition-colors">Our Mission</li>
                <li className="hover:text-blue-500 cursor-pointer transition-colors">HRD Korea Center</li>
                <li className="hover:text-blue-500 cursor-pointer transition-colors">11th Generation</li>
                <li className="hover:text-blue-500 cursor-pointer transition-colors">Career Path</li>
              </ul>
            </div>

            <div>
              <h4 className="text-xs font-black uppercase tracking-[0.2em] text-white mb-6">Contact Support</h4>
              <ul className="space-y-4 text-sm font-medium text-slate-400">
                <li className="flex items-center gap-3"><Phone className="h-4 w-4 text-blue-500" /> +855 12 850 001</li>
                <li className="flex items-center gap-3"><Mail className="h-4 w-4 text-blue-500" /> support@stockflow.com</li>
                <li className="flex items-center gap-3 text-xs leading-relaxed"><MapPin className="h-4 w-4 text-blue-500 flex-shrink-0" /> Korea Software HRD Center, Phnom Penh</li>
              </ul>
            </div>

            <div>
              <h4 className="text-xs font-black uppercase tracking-[0.2em] text-white mb-6">Security & Trust</h4>
              <ul className="space-y-4 text-sm font-medium text-slate-400">
                <li className="flex items-center gap-3 hover:text-blue-500 cursor-pointer transition-colors"><ShieldCheck className="h-4 w-4 text-emerald-500" /> Privacy Shield</li>
                <li className="flex items-center gap-3 hover:text-blue-500 cursor-pointer transition-colors"><Package className="h-4 w-4 text-blue-500" /> Verified Logistics</li>
                <li className="flex items-center gap-3 hover:text-blue-500 cursor-pointer transition-colors"><ArrowRight className="h-4 w-4 text-orange-500" /> Terms of Service</li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-16 border-t border-slate-900 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-8 text-[10px] font-black uppercase tracking-widest text-slate-600">
              ...
              <span className="hover:text-slate-400 cursor-pointer">Changelog</span>
            </div>
          </div>
        </div>
      </footer>
