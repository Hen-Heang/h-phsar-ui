...
export default function HomeComponent() {
  ...
  const heroSlides = [
    {
      image:
        require("../../../assets/images/forCarousel4.webp")?.default ||
        require("../../../assets/images/forCarousel4.webp"),
      title: "Direct from Distributors",
      subtitle:
        "Get the best wholesale prices directly from verified local suppliers.",
    },
    {
      image:
        require("../../../assets/images/retailer/forCarousel.jpg")?.default ||
        require("../../../assets/images/retailer/forCarousel.jpg"),
      title: "Efficient Inventory",
      subtitle:
        "Restock your store with ease using our modern management tools.",
    },
    {
      image:
        require("../../../assets/images/retailer/woman-checking-her-delivery-groceries.jpg")
          ?.default ||
        require("../../../assets/images/retailer/woman-checking-her-delivery-groceries.jpg"),
            ...
            <div className="absolute inset-0 z-20 flex flex-col items-center justify-center px-4 text-center">
              ...
              >
                ...
                <div className="mt-10 flex flex-wrap justify-center gap-4">
                  <Button
                    size="lg"
                    className="h-14 rounded-2xl bg-orange-500 px-8 text-base font-bold text-white hover:bg-orange-600"
                  >
                    Explore Marketplace
                  </Button>
                  <Button
      ...
      <div className="mx-auto max-w-[105rem] px-4 sm:px-6 lg:px-8">
        ...
        <motion.section variants={itemVariants} className="mt-16">
          <div className="mb-8 flex items-end justify-between">
            ...
            <Button
              variant="ghost"
              className="hidden items-center gap-2 text-orange-500 hover:text-orange-600 sm:flex"
            >
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-2xl">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Button
                size="lg"
                className="h-14 rounded-2xl bg-white px-8 text-base font-bold text-orange-600 hover:bg-orange-50"
              >
                Start Shopping Now
              </Button>
            </div>
