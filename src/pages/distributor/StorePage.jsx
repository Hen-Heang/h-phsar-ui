          ...
          <div className="p-8 md:p-12">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
              ...
              <div className="flex gap-3">
                {edit && (
                  <Button type="button" onClick={handleEdit} className="h-12 px-8 rounded-xl font-bold bg-slate-900 hover:bg-slate-800 text-white">
                    Edit Store Details
                  </Button>
                )}
                {cancel && (
                  <Button type="button" variant="outline" onClick={handleCancelEdit} className="h-12 px-8 rounded-xl font-bold border-slate-200">
                    Cancel
                  </Button>
                )}
                {save && (
                  <Button type="button" onClick={() => setShowsave(true)} className="h-12 px-8 rounded-xl font-bold bg-blue-600 hover:bg-blue-700 text-white">
                    Save Changes
                  </Button>
                )}
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-500">This information will be visible to retailers browsing the platform.</p>
              </div>
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    />
                    {errors.primaryPhone && <p className="text-rose-500 text-xs font-bold">{errors.primaryPhone}</p>}
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Secondary Phone (Optional)</label>
                    <input
      ...
      <Dialog open={showSave} onOpenChange={setShowsave}>
        <DialogContent className="max-w-md p-8 rounded-[2.5rem] border-none shadow-2xl">
          <div className="text-center">
            ...
            <DialogTitle className="text-2xl font-black text-slate-900 mb-2">Update Store Profile?</DialogTitle>
            <p className="text-slate-500 mb-8">Confirming will update your public store information for all retail partners.</p>
