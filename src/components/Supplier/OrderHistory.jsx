...
import { get_order_history } from "../../redux/services/supplier/OrderHistory.service";
import { getOrderHistory, setLoadingHistory } from "../../redux/slices/supplier/orderHistorySlice";
import { get_invoice_by_id } from "../../redux/services/supplier/invoice.service";
...
import { getInvoiceById, getInvoiceOrder } from "../../redux/slices/supplier/invoiceDistributorSlice";
...
export default function OrderHistory() {
  ...
  useEffect(() => {
    document.title = "H-Phsar | Distribution Archive";
    fetchHistory();
  }, [dispatch]);
