...
import {
  getImportHistory,
  setLoadingHistory,
} from "../../redux/slices/supplier/importHistorySlice";
import { get_import_history } from "../../redux/services/supplier/ImportHistory.service";
...
export default function History() {
  ...
  useEffect(() => {
    document.title = "H-Phsar | Import Audit";
    fetchHistory();
  }, [dispatch]);
