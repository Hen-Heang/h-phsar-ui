...
export function ContactForm() {
  ...
  return (
    <section className="mx-auto max-w-3xl px-4 pb-20 md:px-6">
      ...
      <p className="mt-2 text-slate-600 ">react-hook-form + zod with inline validation messages.</p>

      <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4 rounded-2xl border border-slate-200 p-6 ">
        <div>
