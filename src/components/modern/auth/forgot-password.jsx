...
export function ForgotPassword({ onSendOTP, onResetPassword, onBack, isLoading, step, email }) {
  const {
    register: regEmail,
    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleResetSubmit(onResetPassword)} className="space-y-4">
        <div className="space-y-2">
          ...
          {resetErrors.otp && (
            <p className="text-xs font-medium text-red-500">{resetErrors.otp.message}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          {resetErrors.password && (
            <p className="text-xs font-medium text-red-500">{resetErrors.password.message}</p>
          )}
        </div>
