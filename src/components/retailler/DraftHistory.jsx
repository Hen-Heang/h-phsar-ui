...
import { setLoadingDraft } from "../../redux/slices/retailer/draftHistorySlice";
import {
  deleteTheDraft,
  draftToRequest1,
  getDraftHis,
...
export default function DraftHistory() {
  ...
  const getAllDraftHistory = useCallback(() => {
        ...
        <header className="mb-12 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-slate-500 max-w-xl">
              Manage and finalize your saved shopping carts. Ready to stock up?
              Just hit checkout.
            </p>
          </div>
          <div className="bg-white px-6 py-3 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-3">
            ...
            <span className="text-xs font-bold text-slate-600">
              You have {draftHistoryList.length} items in waiting
            </span>
          </div>
        </header>
        ...
        {loading ? (
          ...
          >
            ...
            <h3 className="text-xl font-bold text-slate-900">
              Your draft folder is clear
            </h3>
            <p className="text-slate-500 mt-2 max-w-xs mx-auto">
              Any carts you save for later will appear here for finalized
              processing.
            </p>
          </motion.div>
        ) : (
        ...
        <DialogContent className="max-w-4xl overflow-hidden rounded-[3rem] p-0 border-none shadow-2xl">
          <div className="bg-orange-500 px-10 py-12 text-white relative">
            ...
            <p className="mt-2 text-orange-100 font-medium">
              Verify your items before sending the request to{" "}
              <span className="font-bold border-b-2 border-white/30">
                {selectedDraft?.name}
              </span>
              .
            </p>
