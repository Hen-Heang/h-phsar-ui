                  ...
                  <div ref={props.invoiceRef} className="px-2">
                      ...
                      <div className="w-2/3 flex flex-wrap text-black">
                        ...
                        <div className="w-30 text-black font-medium ml-2 mt-1">
                          <p className="text-lg font-semibold">
                            {orderInvoiceList.storeName}
                          </p>
                          <p className="text-xs element">
                            {orderInvoiceList.storeAddress}
                          </p>
                        </div>
                      </div>
                      <div className="w-1/3 justify-between font-medium text-xs">
                        <h1 className="text-retailerPrimary text-2xl">
                          INVOICE
                        </h1>
                        <p>Invoice Number: #{orderInvoiceList.id}</p>
                        <p>
                          Invoice Date:
                          {new Date(orderInvoiceList.date).toLocaleDateString(
                            "en-GB",
                            {
                              day: "numeric",
                              month: "long",
                    ...
                    <div className="flex bg-white mt-2">
                      <div className="w-2/3 text-xs  text-black">
                        <p className="text-xs text-retailerPrimary">
                          Invoice To:
                        </p>
                      ...
                      <div className="w-1/3 justify-between text-xs">
                        ...
                        <p className="line-clamp-1 overflow-hidden">
                          Email:{orderInvoiceList.storeEmail}
                        </p>
                      </div>
                    </div>
                        ...
                        <tbody>
                          {productList.map((item, index) => (
                            <tr key={item.id} className=" border-b text-black ">
                              ...
                              <td className="px-6 py-4">
                                {item.qty === null ? <span>0</span> : item.qty}
                              </td>
                              <td className="px-6 py-4">
                    ...
                    <div className="flex justify-end mt-2 px-4">
                      <div className="w-1/2 text-sm text-newGray">shipping</div>
                      <div className="w-1/2 flex text-end justify-end text-xs">
                        $1.00
                      </div>
                    </div>
                ...
                <div className="relative">
                  ...
                  <div className="flex bg-white mt-2">
                    <div className="w-2/3 text-xs  text-black">
                      ...
                      <p className="text-sm text-semibold"></p>
