...
import {
  getAllHistory,
  setLoadingHistoryRetail,
} from "../../redux/slices/retailer/historySlice";
import { get_invoice } from "../../redux/services/retailer/invoice.service";
import {
  getInvoice,
  getOrderInvoice,
} from "../../redux/slices/retailer/invoiceRetailerSlice";
  ...
  const handleInvoice = (id) => {
    ...
    get_invoice(id).then((r) => {
      if (!r || r.status === 401 || r.status === 403) {
        toast.error("Unable to load invoice. Please try again.");
        setInvoice(false);
        ...
        <header className="mb-12 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-slate-500 max-w-xl">
              Access your full procurement history, download tax invoices, and
              track past stock movements.
            </p>
          </div>
        ...
        {loading ? (
          ...
          >
            ...
            <p className="text-slate-500 mt-2 max-w-xs mx-auto">
              Your completed and cancelled transactions will appear here for
              your records.
            </p>
          </motion.div>
        ) : (
