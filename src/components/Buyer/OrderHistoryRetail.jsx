...
import { get_all_history } from '../../redux/services/buyer/history.service';
import { getAllHistory, setLoadingHistoryRetail } from '../../redux/slices/buyer/historySlice';
import { get_invoice } from '../../redux/services/buyer/invoice.service';
import { getInvoice, getOrderInvoice } from '../../redux/slices/buyer/invoiceRetailerSlice';
import { get_orderById } from '../../redux/services/buyer/orderDetail.service';
import { getOrderById } from '../../redux/slices/buyer/orderDetailSlice';
...
export default function OrderHistoryRetail() {
  ...
  useEffect(() => {
    document.title = "H-Phsar | Order Archive";
    fetchHistory();
  }, [dispatch]);
                          ...
                          <div className="col-span-1 lg:col-span-4 flex items-center gap-4">
                            ...
                            <div className="min-w-0">
                              ...
                              <span className="lg:hidden block text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                                Order #{String(item.order.id).slice(-8).toUpperCase()}
                              </span>
                            </div>
                          </div>
